...
//  AR T-Shirt
//
//  Created by Leban Issa on 2019-06-18.
//  Copyright © 2019 Leban Issa. All rights reserved.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor) {
        ...
        guard let imageAnchor = anchor as? ARImageAnchor, let fileUrlString = Bundle.main.path(forResource: "kawhigamewinner", ofType: "mp4") else {return}
        //find our video file
